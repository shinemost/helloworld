...
func (receiver *HelloworldClient) PostGenStudent(ctx context.Context, _headers map[string]string, body dto.Student, options Options) (_resp *resty.Response, data int32, err error) {
	var _err error
...
func (receiver *HelloworldClient) PostGenStudents(ctx context.Context, _headers map[string]string, body []dto.Student, options Options) (_resp *resty.Response, data []int32, err error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
...
func (receiver *HelloworldClient) GetGenStudent_Id(ctx context.Context, _headers map[string]string, id int32, options Options) (_resp *resty.Response, data dto.Student, err error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
...
func (receiver *HelloworldClient) PutGenStudent(ctx context.Context, _headers map[string]string, body dto.Student, options Options) (_resp *resty.Response, re error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
...
func (receiver *HelloworldClient) DeleteGenStudent_Id(ctx context.Context, _headers map[string]string, id int32, options Options) (_resp *resty.Response, re error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
...
func (receiver *HelloworldClient) GetGenStudents(ctx context.Context, _headers map[string]string, parameter dto.Parameter, options Options) (_resp *resty.Response, data dto.Page, err error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
...
func NewHelloworldClient(opts ...restclient.RestClientOption) *HelloworldClient {
	defaultProvider := restclient.NewServiceProvider("HELLOWORLD")
